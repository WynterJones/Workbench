...
const SHELVES: { id: ShelfId; label: string; explain: string }[] = [
  ...
  { id: "unsorted", label: "Not Sorted", explain: "No status picked yet. Every new project lands here." },
  { id: "experiments", label: "Experiments", explain: "Status set to experiment." },
  { id: "shipped", label: "Shipped", explain: "Status set to shipped, or tagged “shipped”." },
  { id: "in-progress", label: "In Progress", explain: "Status set to in progress." },
