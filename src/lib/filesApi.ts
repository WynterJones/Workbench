...
export const filesApi = {
  ...
  createDir: (path: string, name: string) => invoke<FsEntry>("fs_create_dir", { path, name }),
  ...
  moveEntries: (paths: string[], dest: string) => invoke<void>("fs_move_entries", { paths, dest }),
  copyEntries: (paths: string[], dest: string) => invoke<void>("fs_copy_entries", { paths, dest }),
  ...
  saveStarter: (starter: StarterTemplate) => invoke<void>("fs_save_starter", { starter }),
  deleteStarter: (starterId: string) => invoke<void>("fs_delete_starter", { starterId }),
  saveFolderAsStarter: (path: string, meta: Partial<StarterTemplate>) =>
    invoke<StarterTemplate>("fs_save_folder_as_starter", { path, meta }),
